/*global $, define, document, FileReader,  Pixastic, parseInt, parseFloat, Image, ngettext, gettext, assert, assertTrue */
       ...
       function (declare, View) {
          return declare(View, {
             ...
             edit : function (event) {
                ...
                assertTrue($("#ui-editor").size() > 0, "DOM element for the editor must not be undefined");

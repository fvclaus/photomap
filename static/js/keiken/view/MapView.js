...
function (declare, View, MapPresenter, communicator, MarkerView, InfoText) {
  var MapView = declare(View, {
    ...
    expandBounds: function (instance) {
      ...
      var lng = instance.getLng()
      var lowerLatLng = new google.maps.LatLng(lat - 0.2, lng - 0.2)
      var upperLatLng = new google.maps.LatLng(lat + 0.2, lng + 0.2)
      var newBounds = new google.maps.LatLngBounds(lowerLatLng, upperLatLng)
    ...
    fit: function (markersinfo) {
      var LatLngList = []; var i; var len; var bounds; var LtLgLen; var minfo
    ...
    createMarker: function (data) {
      ...
      var lng = (isNaN(parseFloat(data.lon))) ? parseFloat(data.lng) : parseFloat(data.lon)
      var markerIsPlace = (data.getType() === "Place")
      var icon = markerIsPlace ? PLACE_DEFAULT_ICON : ALBUM_DEFAULT_ICON
      var iconWidth = markerIsPlace ? PLACE_ICON_WIDTH : ALBUM_ICON_WIDTH
      var iconHeight = markerIsPlace ? PLACE_ICON_HEIGHT : ALBUM_ICON_HEIGHT
      var shadowWidth = markerIsPlace ? PLACE_ICON_SHADOW_WIDTH : ALBUM_ICON_SHADOW_WIDTH
      var shadowIcon = markerIsPlace ? PLACE_SHADOW_ICON : ALBUM_SHADOW_ICON

...
function (CarouselAnimation, TestEnv) {
  describe("CarouselAnimation", function () {
    var $item
    var $loader
    var animation
    var interval
    ...
    beforeEach(function () {
      var $container = new TestEnv().append($("<div id='CarouselAnimation'><span class='mp-carousel-animation-loader' /><span class='mp-carousel-animation-item' /></div>"))

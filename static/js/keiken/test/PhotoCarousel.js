...
define(["../widget/PhotoCarouselWidget",
  "./TestFixture",
  "../tests/loadTestEnv!"],
function (PhotoCarouselWidget, TestFixture, $testBody) {
  ...
  var $photos = null
  var n$photos = 5
  var assertPhotosInWidget = function (photos, from) {
  ...
  var nExpectedAssertions = 0
  var nExpected$photos = 0
  var expectedPhotos = null
  var $photoIndex = 0
  var disableAssertions = false
  var getExpectedAssertionsForOneLoad = function () {
    return nExpectedAssertions + n$photos
  }
  var afterLoad = null
  var onUpdate = null

  describe("PhotoCarousel", function () {
    beforeEach(function () {

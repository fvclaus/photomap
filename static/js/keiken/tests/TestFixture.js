...
function (declare, Photo, Collection) {
  return declare(null, {
    ...
    getRandomPhoto: function (id) {
      ...
      var nWordsTitle = parseInt(Math.random() * 20, 10)
      var nWordsDescription = parseInt(Math.random() * 300, 10)
      var title = this._generateString(nWordsTitle)
      var description = this._generateString(nWordsDescription)
      return new Photo({
